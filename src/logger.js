// This is the **logger** module. It uses [log4js](https://github.com/nomiddlename/log4js-node) to handle and
// configure all logging that happens inside of the application.
...
var setup = function(level, colors, appenders) {
	...
	appenders = (appenders || [constant.CONSOLE_APPENDER]).map(function(appender) {
		if (appender.type === 'console') {
			if (appender.layout && appender.layout.type === 'pattern') {
